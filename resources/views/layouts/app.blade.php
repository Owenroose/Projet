            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="{{ route('home') }}" class="app-brand-link">
                        <span class="app-brand-text demo menu-text fw-bold">Nova Tech</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item {{ Route::is('admin.profile.*') || Route::is('admin.*') ? 'active open' : '' }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons bx bx-user"></i>
                            <div data-i18n="Authentications">Profile</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item {{ Route::is('admin.profile.edit') ? 'active' : '' }}">
                    ...
                    <li class="menu-item {{ Route::is('admin.team-members.*') ? 'active' : '' }}">
                        <a href="{{ route('admin.team-members.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-user-plus"></i>
                            <div data-i18n="Users">Team Members</div>
                        </a>
                    </li>
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        <img src="{{ asset('assets/img/avatars/user_default.png') }}" alt
                    ...
                    <footer class="content-footer footer bg-footer-theme">
                        <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                            <div class="mb-2 mb-md-0">
                                ...
                                , made with ❤️ by
                                <a href="https://novatechbenin.com" target="_blank"
                                    class="footer-link fw-medium">Nova Tech Bénin</a>
                            </div>
                        </div>
                    </footer>
