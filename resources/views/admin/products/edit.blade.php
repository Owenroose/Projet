...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Administration / Produits /</span> Modifier "{{ $product->name }}"
        </h4>
        ...
        <div class="row">
            <div class="col-xl-8">
                        ...
                        <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                       id="name" name="name" value="{{ old('name', $product->name) }}" placeholder="Entrez le nom du produit" required>
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror"
                                          id="description" name="description" rows="5" placeholder="Description du produit" required>{{ old('description', $product->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('specifications') is-invalid @enderror"
                                          id="specifications" name="specifications" rows="4" placeholder="Entrez les spécifications, ex: 'Couleur: Noir' ou 'RAM: 8 Go'">{{ old('specifications', $product->specifications) }}</textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('brand') is-invalid @enderror"
                                           id="brand" name="brand" value="{{ old('brand', $product->brand) }}" placeholder="Ex: HP">
                                    @error('brand')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('category') is-invalid @enderror"
                                       id="category" name="category" value="{{ old('category', $product->category) }}" placeholder="Ex: Ordinateurs" required>
                                @error('category')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                @if($product->image)
                                    <div class="mb-3">
                                        <img src="{{ asset('storage/' . $product->image) }}" alt="Image actuelle" class="img-fluid rounded" style="max-height: 200px;">
                                        <small class="d-block text-muted mt-2">Image actuelle du produit. Pour la modifier, choisissez un nouveau fichier ci-dessous.</small>
                                    </div>
                                @endif
                            ...
                            <div class="mb-3" id="stock-quantity-container" style="display: {{ old('in_stock', $product->in_stock) ? 'block' : 'none' }};">
                ...
                <div class="card">
                    <div class="card-header"><h5 class="mb-0">Supprimer le produit</h5></div>
                    <div class="card-body">
                        <p class="text-danger">Cette action est irréversible et supprimera définitivement le produit et ses données.</p>
